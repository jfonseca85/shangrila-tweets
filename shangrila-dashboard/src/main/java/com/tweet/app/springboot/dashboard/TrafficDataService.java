package com.tweet.app.springboot.dashboard;
...
import com.tweet.app.springboot.dao.POITrafficDataRepository;
import com.tweet.app.springboot.dao.TotalTrafficDataRepository;
import com.tweet.app.springboot.dao.TotalTweetsFollwersTrafficDataRepository;
import com.tweet.app.springboot.dao.TotalTweetsUsuarioTrafficDataRepository;
import com.tweet.app.springboot.dao.WindowTrafficDataRepository;
import com.tweet.app.springboot.dao.WindowTweetTrafficDataRepository;
import com.tweet.app.springboot.dao.entity.POITrafficData;
import com.tweet.app.springboot.dao.entity.TotalTrafficData;
import com.tweet.app.springboot.dao.entity.TotalTweetsFollwersTrafficData;
import com.tweet.app.springboot.dao.entity.TotalTweetsUsuarioTrafficData;
import com.tweet.app.springboot.dao.entity.WindowTrafficData;
import com.tweet.app.springboot.dao.entity.WindowTweetTrafficData;
import com.tweet.app.springboot.vo.Response;
...
public class TrafficDataService {
	...
	public void trigger() {
		...
		follwersTrafficDataRepository.findTrafficDataByDate(sdf.format(new Date())).forEach(e -> totalTweetsFollwersTrafficList.add(e));
		usuarioTrafficDataRepository.findTrafficDataByDate(sdf.format(new Date())).forEach(e -> totalTweetsUsuarioTrafficList.add(e));
		windowRepository.findTrafficDataByDate(sdf.format(new Date())).forEach(e -> windowTrafficList.add(e));
		windowTweetRepository.findTrafficDataByDate(sdf.format(new Date())).forEach(e -> windowTweetTrafficList.add(e));
